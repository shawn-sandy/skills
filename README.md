...
| [humanize-text](skills/humanize-text) | Rewrites AI-sounding text into natural prose, flagging stock vocabulary, formulaic structure, and promotional tone. Use when asked to humanize text or make writing sound less like AI. |
