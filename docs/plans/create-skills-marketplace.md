...
- [x] npx skills add shawn-sandy/skills installs the flagship set from a clean scratch project for Claude Code, Codex CLI, Cursor, and Gemini CLI targets
- [x] Every skills directory passes the Agent Skills spec validator with zero errors
- [x] docs/triage.md records an include or exclude verdict for all 60 candidate skills
- [x] The repository is public at github.com/shawn-sandy/skills with the validate workflow green on main
- [x] bash tests/verify-install.sh exits 0 against the published repository
- [x] The pilot plugin reinstalls cleanly in Claude Code with its skill content sourced from shawn-sandy/skills
- [x] No published skill carries disable-model-invocation or CLAUDE_PLUGIN_ROOT references
- [x] Every published skill's name field matches its directory name
- [x] The v0.1.0 tag exists on the published repository
